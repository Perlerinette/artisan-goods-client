...
const Auth = (props) => {
    ...
    return(
        ...
        <Container className = "auth-container align-middle" style={{padding: 10}} >
            ...
            <div style={{ width: "1600px", marginLeft: "-140px", paddingLeft: "-200px !important", position: "relative", left: "-100px"}}class="custom-shape-divider-bottom-1614655104">
...
<div className="pinkLoginDiv"></div>
            ...
            <Row className='justify-content-md-center' >
                ...
                <a  style={{cursor:'pointer', fontSize: 22, padding: 5}} onClick={toggle}>Already have an account? Log in.</a>}
            </Row>
